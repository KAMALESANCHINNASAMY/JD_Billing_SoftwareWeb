...
@Component({
  selector: 'app-sales-ledger-nongst',
  standalone: false,
  templateUrl: './sales-ledger-nongst.component.html',
  styleUrl: './sales-ledger-nongst.component.scss'
})
export class SalesLedgerNongstComponent {
  ...
  async search() {
    ...
    if (this.reportForm.valid) {
      this.salesList = await this.lSvc.getSalesNonGst(id, fromDate, toDate).toPromise() || [];
