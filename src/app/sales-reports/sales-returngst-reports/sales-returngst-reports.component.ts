...
@Component({
  selector: 'app-sales-returngst-reports',
  templateUrl: './sales-returngst-reports.component.html',
  styleUrl: './sales-returngst-reports.component.scss',
  providers: [DatePipe]
})
export class SalesReturngstReportsComponent implements OnInit {
  ...
  getSalesReturnReports() {
    if (this.reportForm.valid) {
      ...
      this.SLSRSVC.getSalesBillingReturngstFromToDate(fromDate, toDate, cusId, this.companyID).subscribe((res) => {
  ...
  totalnet_total() {
    ...
    return_net_total = this.returnReports.reduce(
