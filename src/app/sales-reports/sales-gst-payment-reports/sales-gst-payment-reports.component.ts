...
@Component({
  selector: 'app-sales-gst-payment-reports',
  templateUrl: './sales-gst-payment-reports.component.html',
  styleUrl: './sales-gst-payment-reports.component.scss',
  providers: [DatePipe]
})
export class SalesGstPaymentReportsComponent implements OnInit {
  ...
  async getSalesPaymentReports() {
    if (this.reportForm.valid) {
      ...
      let res = await this.SLSRSVC.getSalesBillingPaymentsGstFromToDate(fromDate, toDate, cusId, this.companyID).toPromise();
