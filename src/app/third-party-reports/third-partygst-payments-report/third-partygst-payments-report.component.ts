...
@Component({
  selector: 'app-third-partygst-payments-report',
  templateUrl: './third-partygst-payments-report.component.html',
  styleUrl: './third-partygst-payments-report.component.scss',
  providers: [DatePipe]
})
export class ThirdPartygstPaymentsReportComponent implements OnInit {
  ...
  getSalesPaymentReports(fromdate: any, todate: any) {
    this.TPRSVC.getThirdPartygstPurchasePaymentFromToDate(fromdate, todate, this.companyID).subscribe((res) => {
