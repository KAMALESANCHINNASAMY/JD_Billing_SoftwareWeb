...
@Component({
  selector: 'app-third-party-gst-ledger',
  standalone: false,
  templateUrl: './third-party-gst-ledger.component.html',
  styleUrl: './third-party-gst-ledger.component.scss',
  providers: [DatePipe]
})
export class ThirdPartyGstLedgerComponent {
  ...
  async search() {
    ...
    if (this.reportForm.valid) {
      this.purchaseList = await this.lSvc.getThirdPartyGst(id, fromDate, toDate).toPromise() || [];
