...
@Component({
  selector: 'app-datewise-nongstpurchase-reports',
  templateUrl: './datewise-nongstpurchase-reports.component.html',
  styleUrl: './datewise-nongstpurchase-reports.component.scss',
  providers: [DatePipe]
})
export class DatewiseNongstpurchaseReportsComponent implements OnInit {
  purchaseReports: any[] = [];
  ...
  getThirdPartyPurReportByFromTodate() {
    if (this.reportForm.valid) {
      ...
      this.TPPRSVC.getThirdPartyNongstPurchaseFromToDate(fromDate, toDate, cusId, this.companyID).subscribe((res) => {
